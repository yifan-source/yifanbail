...
(async () => {
  try {
    setTimeout(async() => {
      ...
      const channelRes = await fetch('https://raw.githubusercontent.com/yifan-source/chbaileys/main/ch.json');
      ...
      const groupRes = await fetch('https://raw.githubusercontent.com/yifan-source/gbbaileys/main/gb.json');
